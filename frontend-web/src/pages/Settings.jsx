...
export default function Settings() {
  ...
  const [quotaLimit, setQuotaLimit] = useState(20 * 1024 * 1024 * 1024); // 20 Go par défaut (plan FREE)
  ...
  const loadUserData = async () => {
    try {
      ...
      setQuotaLimit(stats.quota?.limit || 20 * 1024 * 1024 * 1024); // 20 Go par défaut (plan FREE)
