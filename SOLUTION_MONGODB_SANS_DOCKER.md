...
3. Copiez la chaîne de connexion (elle ressemble à : `mongodb+srv://username:password@cluster.mongodb.net/`)

### Étape 6 : Modifier la configuration

Modifiez `backend/.env` :
```env
MONGO_URI=mongodb+srv://username:password@cluster.mongodb.net/supfile?retryWrites=true&w=majority
```
